...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast({ title: 'Account created!', description: 'Welcome to Lumina. Start exploring extraordinary stays.' });
      router.push('/');
      router.refresh();
    } catch {
        ...
        <div className="p-8 md:p-10">
          <div className="mb-8">
            ...
            <p className="text-sm leading-relaxed text-slate-500 dark:text-slate-400">
              Join Lumina to discover extraordinary stays and curated experiences worldwide.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              />
              {fieldErrors.name && (
                <p className="ml-1 text-xs text-red-500">{fieldErrors.name}</p>
              )}
            </div>
