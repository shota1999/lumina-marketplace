...
export const metadata: Metadata = {
  ...
  description: 'List your property on Lumina and earn income from travelers seeking extraordinary stays.',
};
...
const benefits = [
  {
    ...
    description: 'Set your own prices, availability, and house rules. Keep the majority of every booking.',
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description: 'Reach travelers worldwide with our curated marketplace and search-optimized listings.',
  },
  {
    icon: Star,
  ...
  },
  {
    ...
    description: 'Analytics dashboard, calendar management, and messaging — everything you need in one place.',
  },
  {
    icon: TrendingUp,
    title: 'Smart pricing',
...
const steps = [
  { step: '01', title: 'Create your listing', description: 'Add photos, describe your space, and set your price.' },
  { step: '02', title: 'Get verified', description: 'We review your listing to ensure it meets our quality standards.' },
  { step: '03', title: 'Start hosting', description: 'Accept bookings, welcome guests, and start earning.' },
];
  ...
  return (
    <div>
      ...
      <section className="bg-secondary/30">
        <div className="container py-16">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {benefits.map((b) => (
              <Card key={b.title} className="border-0 shadow-none bg-background">
      ...
      <section className="container py-16 text-center">
        ...
        <div className="mx-auto grid max-w-3xl grid-cols-3 gap-8">
          {[
            ...
            <div key={e.label}>
              <div className="text-2xl font-bold">{e.value}<span className="text-base font-normal text-muted-foreground">/mo</span></div>
      ...
      <section className="container pb-20">
        <div className="mx-auto max-w-xl rounded-2xl bg-primary p-8 text-center text-primary-foreground">
