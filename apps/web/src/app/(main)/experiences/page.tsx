...
export const metadata: Metadata = {
  ...
  description:
    'Discover unique activities and curated experiences hosted by passionate locals worldwide.',
};
...
const PAIRINGS = [
  {
    ...
    category: 'villa',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuCyEoexvxIBudQQM_lb7YGsvu0Hk0Z97V36jhnM8Lj41hMlOdyPIATWXhwViXGyd3HHJnyDKU4vMH5oJX0e6A8bqdsyuIO5yKY4b7ndoGi5MCKSB1P2onu0Ecmo4uPPqGS8STShkPwjpqL5g5mtKwlL6JDLo5Q0VTSTHs3Vk3nCsJmDPPfujzIQHSfa1M0a3e8CKhw9qpLLZXYNggIVjj6pBNXh9EbnlYymz0O1lEZ0ZAqig5a4f_5jTkgBalOGGAz4ISR_nPkUo-o',
  ...
  },
  {
    ...
    category: 'farmhouse',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuDC0A6K2zLKDpkAHSmwtxaSVkjtZ7lQimrjy4lfaHg9TgJQMmJueMKciYtc_c8eCbRcrRA40qjaQrr8jJkJr6WE6KIx19BY9oFB30oXubnt47TG1nc0HKgSUjVeDP0Bxu1Rx-yVfduHXMKEhT5t1iiY3ZlZeHKb1Wh_tZOuXFdbUleUOmpOBKXQ1M603Qd_zqh7Y2T0VDSEfF2zfsYLVLcXPvP5Zp0jlr00jFZc2wO89qQsZmjQZWqx7RD5B2q6maGngEZjzeA1crU',
  ...
  },
  {
    ...
    category: 'penthouse',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuD9qvItgHjnyI8eyV1s9Ef-KOffe9CG7TvsCTDLepeCrlNKeuXKhu-7u6pPu816TDxP8ScRLISJSKZNteNXZLwTIxJHA5IDMJUqaPQVOIqjX9Q1aO8xigh3jZ1rMinjA-XNwS-LyKRLlYHkJeve_YwXbftRsZfKHRoZ9pLu9oJckkZLkh0krm0FC9YVN2Oim62G6iTGqPZ9TocTJlO7Q0C1rb25RHjgHe0L-4rGySEtCPgSFBN5est__mfq0q28Rg8Msfj9pDLaaMk',
      ...
      <section id="journeys" className="mx-auto max-w-[1400px] px-8 py-24">
        <div className="mb-16 flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="text-4xl font-black tracking-tighter text-slate-900 md:text-5xl dark:text-slate-50">
              Choose your journey.
            </h2>
          </div>
          <p className="max-w-sm text-sm leading-relaxed text-slate-500 dark:text-slate-400">
            Six curated worlds. Pick the one that calls — every entry is hand-vetted by our local
            concierge team.
          </p>
        </div>

        <div className="grid grid-cols-1 divide-y divide-slate-200 overflow-hidden rounded-3xl border border-slate-200 bg-white sm:grid-cols-2 sm:divide-y-0 lg:grid-cols-3 dark:divide-slate-800 dark:border-slate-800 dark:bg-slate-900 sm:[&>*:nth-child(2n)]:border-l lg:[&>*:nth-child(2n)]:border-l-0 lg:[&>*:nth-child(3n+2)]:border-l lg:[&>*:nth-child(3n+3)]:border-l sm:[&>*:nth-child(n+3)]:border-t lg:[&>*:nth-child(n+4)]:border-t [&>*]:border-slate-200 [&>*]:dark:border-slate-800">
          {EXPERIENCES.map((exp, idx) => {
            ...
            return (
              <Link
                ...
                className="group relative flex min-h-[340px] flex-col gap-6 p-8 transition-colors duration-300 hover:bg-slate-50 md:p-10 dark:hover:bg-slate-800/50"
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <span className={`block h-[3px] w-10 rounded-full ${exp.colorIcon}`} />
                ...
                <div className="pointer-events-none absolute bottom-8 right-8 flex h-9 w-9 items-center justify-center rounded-full bg-slate-900 text-slate-50 opacity-0 transition-all duration-300 group-hover:opacity-100 md:bottom-10 md:right-10 dark:bg-slate-50 dark:text-slate-900">
                  <ArrowRight
